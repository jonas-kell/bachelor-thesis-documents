An \emph{inductive bias} is a necessary assumption or rule that allows a algorithm to make an inductive leap and generalize knowledge to be able to evaluate previously unseen data \cite{needForBias}.
