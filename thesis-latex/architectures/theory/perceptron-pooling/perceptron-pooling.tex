In the most basic sense, all neural network operators need to be able to take a set of number in and perform calculations on them, then provide an output.
