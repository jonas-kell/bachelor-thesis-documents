...
\label{sec:experiments}
    ...
    \input{./experiments/image-classification/introduction}
        \subsection{Training Settings}
        \label{sec:experiments-trainingsettings}
        \input{./experiments/image-classification/training-settings/training-settings}
        \FloatBarrier
        \subsection{Importance of Positional Encoding}
        \label{sec:experiments-positionalencoding}
        \input{./experiments/image-classification/positional-encoding/positional-encoding}
        \FloatBarrier
        \subsection{Comparison of different Token Mixers}
        \label{sec:experiments-tokenmixers}
        \input{./experiments/image-classification/comparison-token-mixers/comparison-token-mixers}
        \FloatBarrier
        \subsection{Efficiency of Graph Attention}
        \label{sec:experiments-efficiency-graphs}
        \input{./experiments/image-classification/efficiency-graphs/efficiency-graphs}
        \FloatBarrier

    \section{Metaformer in Ground State Search}
    \label{sec:experiments-ground-state-search}
    \input{./experiments/ground-state-search/introduction}
        \subsection{Comparison to established Architectures}
        \label{sec:experiments-comparisontoestablished}
        \input{./experiments/ground-state-search/comparison-established/comparison-established}
        \FloatBarrier
        \subsection{Resiliency to the Choice of Lattice Encoding}
        \label{sec:experiments-resiliencylatticeencoding}
        \input{./experiments/ground-state-search/resiliency-encoding/resiliency-encoding}
        \FloatBarrier
        \subsection{Optimizing the Ansatz}
        \label{sec:experiments-optimizingtheansatz}
        \input{./experiments/ground-state-search/ansatz/ansatz}
        \FloatBarrier
        \subsection{Choice of Hyperparameters}
        \label{sec:experiments-hyperparameters}
        \input{./experiments/ground-state-search/hyperparameters/hyperparameters}
        \FloatBarrier
        \subsection{Differences across the Phase Diagram}
        \label{sec:experiments-phasecriticalpoint}
        \input{./experiments/ground-state-search/differences-phase-diagramm/differences-phase-diagramm}
        \FloatBarrier
